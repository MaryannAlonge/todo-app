import React, {useState} from 'react'
 ...
 const EditTodo = ({ todo }) => { //destructure the {todo} as a pprops here
  const [description, setDescription] = useState(todo.description) // set the default data to the props
  // edit and save description function
